...
(function(){
  ...
  function decorateQrCards(){
    ...
    if(cards[1]&&!cards[1].querySelector('.v44-qr-type')){var b=document.createElement('div');b.className='v44-qr-type';b.innerHTML='<div class="ico">👤</div><div class="copy"><strong>QR zákazníka</strong><small>Kontaktní údaje a rychlý start</small></div>';cards[1].insertBefore(b,cards[1].firstChild);var h2=cards[1].querySelector('h3');if(h2)h2.style.display='none'}
  }
  ...
  function install(){var l=document.createElement('link');l.rel='stylesheet';l.href='css/v44-polish.css';document.head.appendChild(l);installHeadings();decorateQrCards();renderLog()}
