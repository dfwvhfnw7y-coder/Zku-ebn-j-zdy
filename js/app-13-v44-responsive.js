...
(function(){
  ...
  function install(){loadCss();setNavA11y();updatePageTitle();removeLegacyFlow();enhanceEmptyActive();var s=document.createElement('script');s.src='js/app-14-v44-fleet.js?v=44';s.onload=function(){var x=document.createElement('script');x.src='js/app-15-v44-event-fleet.js?v=44';document.body.appendChild(x)};document.body.appendChild(s)}
