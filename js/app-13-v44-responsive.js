/* ── V44 responsive UI state / V45 simplified flow / V46 test loader ── */
(function(){
  ...
  function updatePageTitle(){var active=document.querySelector('.tab.active');var name=active?active.textContent.trim():'Domů';document.title='Zkušební jízdy · '+name+' · v46'}
  ...
  function loadV46Stability(){if(window.__v46StabilityLoaded)return;window.__v46StabilityLoaded=true;var x=document.createElement('script');x.src='js/app-20-v46-convoy-stability.js?v=46d';document.body.appendChild(x)}
  function loadV46PassengerMove(){if(window.__v46PassengerMoveLoaded){loadV46Stability();return}window.__v46PassengerMoveLoaded=true;var p=document.createElement('script');p.src='js/app-19-v46-convoy-passenger-move.js?v=46d';p.onload=loadV46Stability;document.body.appendChild(p)}
  function loadV46Hotfix(){if(window.__v46ConvoyHotfixLoaded){loadV46PassengerMove();return}window.__v46ConvoyHotfixLoaded=true;var h=document.createElement('script');h.src='js/app-18-v46-convoy-hotfix.js?v=46d';h.onload=loadV46PassengerMove;document.body.appendChild(h)}
  function loadV46(){if(window.__v46ConvoyLoaded){loadV46Hotfix();return}window.__v46ConvoyLoaded=true;var s=document.createElement('script');s.src='js/app-17-v46-convoy.js?v=46d';s.onload=loadV46Hotfix;document.body.appendChild(s)}
  function loadFinalUi(){if(window.__v45FinalUiLoaded){loadV46();return}window.__v45FinalUiLoaded=true;var f=document.createElement('script');f.src='js/app-16-v45-final-ui.js?v=45';f.onload=loadV46;document.body.appendChild(f)}
