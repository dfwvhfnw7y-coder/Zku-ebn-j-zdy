...
(function(){
  ...
  function loadV46Hotfix(){if(window.__v46ConvoyHotfixLoaded){loadV46PassengerMove();return}window.__v46ConvoyHotfixLoaded=true;var h=document.createElement('script');h.src='js/app-18-v46-convoy-hotfix.js?v=46e';h.onload=loadV46PassengerMove;document.body.appendChild(h)}
  function loadV46(){if(window.__v46ConvoyLoaded){loadV46Hotfix();return}window.__v46ConvoyLoaded=true;var s=document.createElement('script');s.src='js/app-17-v46-convoy.js?v=46e';s.onload=loadV46Hotfix;document.body.appendChild(s)}
