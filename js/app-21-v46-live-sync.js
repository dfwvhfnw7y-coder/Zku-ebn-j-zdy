...
(function(){
  ...
  function sync(force){var sig=signature(),changed=force||sig!==lastSig;if(changed){lastSig=sig;refreshOpenConvoy()}if(typeof window.v46PaintFleet==='function'){window.v46PaintFleet();if(typeof requestAnimationFrame==='function')requestAnimationFrame(window.v46PaintFleet)}emit()}
  ...
  document.addEventListener('click',function(){patchRefresh()},true);
})();