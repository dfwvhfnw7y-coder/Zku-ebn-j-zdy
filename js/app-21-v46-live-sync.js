...
(function(){
  ...
  function sync(force){var sig=signature(),changed=force||sig!==lastSig;if(changed){lastSig=sig;refreshOpenConvoy()}if(typeof window.v46PaintFleet==='function')window.v46PaintFleet();emit()}
